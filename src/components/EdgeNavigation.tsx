...
const EdgeNavigation = ({ isExpanded }: EdgeNavigationProps) => {
  ...
  const getPositionClasses = (position: string) => {
    switch (position) {
      case "left-top":
        return "fixed left-8 top-1/3 -translate-y-1/2 writing-vertical rotate-180";
      case "left-bottom":
        return "fixed left-8 bottom-1/3 translate-y-1/2 writing-vertical rotate-180";
      case "bottom-left":
        return "fixed bottom-8 left-1/3 -translate-x-1/2";
      case "bottom-right":
        return "fixed bottom-8 right-1/3 translate-x-1/2";
      case "right":
        return "fixed right-8 top-1/2 -translate-y-1/2 writing-vertical";
      case "top-right":
